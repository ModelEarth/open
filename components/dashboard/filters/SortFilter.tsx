...
const i18nFieldLabels = defineMessages({
  ...
  [OrderByFieldType.ACTIVITY]: { defaultMessage: 'Activity', id: 'ZmlNQ3' },
  [OrderByFieldType.BALANCE]: { defaultMessage: 'Balance', id: 'H5+NAX' },
  [OrderByFieldType.CREATED_AT]: { defaultMessage: 'Date', id: 'P7PLVj' },
  [OrderByFieldType.HOSTED_COLLECTIVES_COUNT]: { defaultMessage: 'Hosted Collectives', id: 'ZwUBB+' },
  [OrderByFieldType.HOST_RANK]: { defaultMessage: 'Host Rank', id: 'lk16D8' },
  [OrderByFieldType.MEMBER_COUNT]: { defaultMessage: 'Members', id: '+a+2ug' },
  [OrderByFieldType.NAME]: { defaultMessage: 'Name', id: 'HAlOn1' },
  [OrderByFieldType.RANK]: { defaultMessage: 'Rank', id: 'VP5+CR' },
  [OrderByFieldType.TOTAL_CONTRIBUTED]: { defaultMessage: 'Total Contributed', id: '8+aG3j' },
});
...
const FieldIconTypes = {
  ...
  [OrderByFieldType.MEMBER_COUNT]: 'NUMERICAL',
...
const i18nSortFieldLabel = (intl, field, i18nCustomLabels?: Record<string, MessageDescriptor>) => {
  ...
  return intl.formatMessage(i18nFieldLabels[field]);
};
...
export function buildSortFilterComponent(
  fieldSchema: z.ZodEnum<any>,
  i18nCustomLabels?: Record<string, MessageDescriptor>,
        ...
        <PopoverContent align="end" className="max-w-52 p-3">
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Select value={value.direction} onValueChange={direction => onChange({ ...value, direction })}>
                <SelectTrigger>
